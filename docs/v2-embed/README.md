...
```html
<script src="https://cdn.jsdelivr.net/gh/GafaMX/GFtheme@v2.0.0-rc.8/docs/v2-sdk/gafa-sdk.js"></script>
...
La URL pública actual es `@v2.0.0-rc.8` (arriba). Azure cuando exista:
...
no se tocan. Si usas env, `VITE_GAFA_SDK_V2_URL` apunta al IIFE (`@v2.0.0-rc.8`).
...
3. Agrega:
   <script src="https://cdn.jsdelivr.net/gh/GafaMX/GFtheme@v2.0.0-rc.8/docs/v2-sdk/gafa-sdk.js"></script>
   No uses @v2/main (404) ni @v2 (jsDelivr lo congela). Tag `v2.0.0-rc.8`.
