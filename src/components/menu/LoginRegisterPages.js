...
class LoginRegisterPages extends React.Component {
  ...
  componentDidMount() {
    ...
    } else if (gafafitSDKAuthorization) {
      this.setState({
        currentPage: "profile",
      });
    } else if (page) {
		if (page === "profile" && !gafafitSDKAuthorization) {
			this.setState({
				currentPage: "login",
			});
		} else {
  ...
  successLoginCallback(result) {
    ...
    if (this._isMounted) {
      ...
      GafaFitSDKWrapper.getMeWithPurchase(function (result) {
        ...
        if (
          !(
            currentComponent.props.hasOwnProperty("preventLoginStateChange") &&
            currentComponent.props.preventLoginStateChange
          )
        ) {
          currentComponent.setState({
            currentPage: "profile",
  ...
  handleClickLogout() {
    ...
    this.setState({ serverError: "", currentPage: "login" });
          ...
          <div className="page-container">
            ...
            <div className="Page-login__footer">
              <nav className="nav">
                <ul>
                  <li>
                    <a onClick={this.handleClickRegister.bind(this)}>
                      {" "}
                      {StringStore.get("NOT_ACCOUNT_QUESTION")}
                    </a>
                  </li>
                  <li>
                    <a onClick={this.handleClickRecovery.bind(this)}>
                      {" "}
                      {StringStore.get("FORGOT_PASSWORD_QUESTION")}
                    </a>
                  </li>
                </ul>
              </nav>
          ...
          <div className="page-container">
            ...
            <div className="Page-login__footer">
              <nav className="nav">
                <ul>
                  <li>
                    <a onClick={this.handleClickLogin.bind(this)}>
                      {" "}
                      {StringStore.get("ACCOUNT_QUESTION")}
                    </a>
                  </li>
                  <li>
                    <a onClick={this.handleClickRecovery.bind(this)}>
    ...
    return (
      <div
        className={
          loginClass +
          "__menu" +
          ` ${preLoading && allowsPreLoading ? "is-loading" : ""}`
        }
      >
            ...
            !this.state.me ? (
              <div
                className={
                  ...
                  buttonClass +
                  "--icon" +
                  " is-primary not-logged"
                }
                onClick={
                  initial === "register"
                    ? this.handleClickRegister.bind(this)
