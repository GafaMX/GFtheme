        ...
        return (
            <div className={loginClass + '__menu'}>
                <div className={loginClass + '__menu-nav'}>
                    ...
                    <Modal className="modal-login" show={this.state.showLogin} onHide={this.handleClickBack.bind(this)}>
                        <div className="modal-login__container">
                            ...
                            <Modal.Header className="modal-login__header">
                                <Modal.Title
                                    className="section-title container">{StringStore.get('BUTTON_LOGIN')}</Modal.Title>
                            </Modal.Header>
                    ...
                    <Modal className="modal-register" show={this.state.showRegister}
                        ...
                        <div className="modal-register__container">
                            ...
                            <Modal.Header className="modal-register__header">
                                <Modal.Title
                                    className="section-title container">{StringStore.get('BUTTON_REGISTER')}</Modal.Title>
                            </Modal.Header>
                    ...
                    <Modal className="modal-profile" show={this.state.showProfile}
                           onHide={this.handleClickBack.bind(this)}>
                    ...
                    <Modal className="modal-password" show={this.state.passwordRecovery}
                           onHide={this.handleClickBack.bind(this)}>
                        <div className="modal-password__container">
                            ...
                            <Modal.Header className="modal-password-header">
                                <Modal.Title
                                    className="section-title container">{StringStore.get('BUTTON_PASSWORD_FORGOT')}</Modal.Title>
                            </Modal.Header>
