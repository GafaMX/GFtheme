...
export default class LoginProwessContainer extends React.Component {
    ...
    render() {
        return (
            <Modal className="modal-password" show={this.props.passwordRecovery} animation={false}
                    ...
                    <div className="col-lg-6">
                        <div className="container">
                            ...
                            <Modal.Body className="modal-password-body">
                                <PasswordRecovery template={this.props.template} token={this.props.token}
                                                  email={this.props.email}
                                                  successCallback={this.props.successRecoveryCallback}/>
                            </Modal.Body>
                        </div>
                    </div>
                    <div className="col-lg-6">
