    ...
    if (staff && staff.hasOwnProperty("job") && staff.job !== null) {
      ...
      return (
        <p className={"reservation-item-staff"}>
          <strong>
            {staff["name"]}{" "}
            {staff.hasOwnProperty("lastname") ? staff["lastname"] : ""}
          </strong>
        </p>
      );
    }
    ...
    return (
      <div className={"pastClass-item"}>
        ...
        <div className={"pastClass-item__body"}>
          <p className={"reservation-item-day"}>
            {moment(this.props.reservation.meeting_start)
              .locale(lang)
              .format(format)}
          </p>
          <p className={"reservation-item-location"}>
            {this.props.reservation.location.name}
          </p>
          <p className={"reservation-item-time"}>
            {moment(this.props.reservation.meeting_start)
              .locale(lang)
              .format("h:mm a")}
          </p>
