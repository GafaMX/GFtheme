        ...
        return (
            <div className={profileClass + '__section is-address'}>
                ...
                <FormGroup className={formClass + "__section is-external_number"} controlId="external_number">
                    <ControlLabel
                        className={formClass + "__label"}>{StringStore.get('LABEL_EXTERNAL_NUMBER')}</ControlLabel>
                    <FormControl
                        className={formClass + "__input"}
                        type="text"
                ...
                <FormGroup className={formClass + "__section is-internal_number"} controlId="internal_number">
                    <ControlLabel
                        className={formClass + "__label"}>{StringStore.get('LABEL_INTERNAL_NUMBER')}</ControlLabel>
                    <FormControl
                        className={formClass + "__input"}
                        type="text"
                ...
                <FormGroup className={formClass + "__section is-postal_code"} controlId="postal_code">
                    <ControlLabel
                        className={formClass + "__label"}>{StringStore.get('LABEL_POSTAL_CODE')}</ControlLabel>
                    <FormControl
                        className={formClass + "__input"}
                        type="text"
                        value={postal_code}
                ...
                <FormGroup className={formClass + "__section is-municipality"} controlId="municipality">
                    <ControlLabel
                        className={formClass + "__label"}>{StringStore.get('LABEL_MUNICIPALITY')}</ControlLabel>
                    <FormControl
                        className={formClass + "__input"}
                        type="text"
                        value={municipality}
