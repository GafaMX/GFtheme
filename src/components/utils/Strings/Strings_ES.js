export default {
  ...
  VALIDATION_EMAIL:
    "no es válido. Verifique la @ y que tenga un dominio correcto.",
  ...
  PASSWORD_FORGOT_SUCCESS:
    "Le hemos enviado un enlace para recuperar su contraseña",
  ...
  CANCELATIONMESSAGEWAITLIST:
    "¿Le gustaría cancelar su lugar en la lista de espera?",
  CANCELLATION_WITHOUT_CREDIT_ALERT:
    "Ya ha pasado la hora límite para cancelar. Si cancelas ahora no recibirás tu crédito de vuelta.",
  RESERVATION: "Reserva",
  ...
  PROFILE_NEXT_WAITLIST_CLASSES: "Lista de espera",
  ...
  PROFILE_NO_UPCOMING_WAITLIST_CLASSES:
    "No cuentas con próximas _|_ en lista de espera",
  ...
  PASSWORD_RESET_SENT_EMAIL_ALERT:
    "¡Correo de cambio de contraseña enviado! Revisa tu bandeja de correo electrónico para continuar el proceso.",
