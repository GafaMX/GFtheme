...
- **Guía para agentes (2026-09-04):** `docs/v2-agente.md` — instalar en Buq-Webs o WordPress: options, THEME, filtros, botones HTML, JS, Concierge (preview) y cross-sell (preview, sin UI). Un agente debe leer eso antes de pegar markup. Colores: `docs/v2-theme-colors.md`. Preview: `/preview.html?theme=base&guest=1`.
...
- **Checkout $0:** si el total queda en 0 (precio 0 o descuento 100%) **no se monta** GafaPay/Stripe/PayPal. CTA “Confirmar pedido” → `/reservate` sin `payment_data`. En el preview, código `GRATIS`.
