...
- **Orden de construcción acordado:** 1) ~~Calendario~~ (ya avanzado, ahora con datos reales) → 2) Fancy/checkout → 3) Login/Registro (+ reCAPTCHA) → 4) Perfil → 5) Paquetes/membresías (lo que menos se usa hoy; construir y solo registrar su ID).
